...
const ProjectCard: React.FC<ProjectCardProps> = ({ name, description, teamName, status, tasks }) => {
  return (
    <div className="min-w-[150px] max-w-[300px] min-h-[150px] p-4 bg-white rounded-2xl shadow-md border border-gray-200 flex flex-col">
      ...
      <div className="mt-auto text-sm font-medium text-green-600">Active Tasks: { tasks }</div>
    </div>
  );
};
